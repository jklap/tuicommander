...
The MCP server must be enabled (Settings > MCP Servers > TUIC MCP Server).

## Adding an Upstream Server

Open Settings > MCP Servers > Upstream MCP Servers. Click **Add Server** and fill in:
...
1. Go to Settings > MCP Servers > Upstream MCP Servers
...
Add it in Settings > MCP Servers > Upstream MCP Servers:
- Name: `filesystem`
- Type: Stdio
- Command: `npx`

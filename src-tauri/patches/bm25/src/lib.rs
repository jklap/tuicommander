...
// Suppress missing docs warning for this file. TUICommander patch: upstream
// writes this as an empty `//!`, which satisfies `missing_docs` but trips
// `clippy::empty_docs`, and this workspace keeps clippy clean.
#![doc = " BM25 search."]

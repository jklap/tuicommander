...
mod tests {
    use super::{
        Path, PathBuf, agent_send_parts, capture_query, disposable_roots,
        is_disposable_root, is_tmux_invocation, looks_like_uuid, match_session,
        resolve_path, session_status, short_id, short_repo, strip_verbatim,
